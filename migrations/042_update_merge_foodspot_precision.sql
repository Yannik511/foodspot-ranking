-- =============================================
-- MIGRATION 042: Update merge_foodspot precision
-- =============================================
-- Setzt die interne Variable v_normalized_score auf NUMERIC(4,2),
-- damit Werte bis 10.00 ohne Overflow verarbeitet werden.
-- =============================================

DROP FUNCTION IF EXISTS merge_foodspot(
  UUID,
  TEXT,
  NUMERIC,
  JSONB,
...
-- =============================================
-- SUCCESS: merge_foodspot precision updated
-- =============================================
